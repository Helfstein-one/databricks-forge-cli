...
def test_project_generator_renders_template(tmp_path: Path):
    ...
    expected_rel_paths = [
        ...
        "config/database_connectors.yaml",
        "sql/01_clean_transactions.sql",
        "sql/02_gold_metrics.sql",
        "sql/03_optimize_tables.sql",
        "sql/04_iceberg_uniform.sql",
        f"src/{slug}/__init__.py",
        f"src/{slug}/session.py",
        f"src/{slug}/catalog.py",
        f"src/{slug}/secrets.py",
        f"src/{slug}/tuning.py",
        f"src/{slug}/logging.py",
        f"src/{slug}/formats.py",
        f"src/{slug}/iceberg.py",
        f"src/{slug}/connectors.py",
        f"src/{slug}/pipelines/__init__.py",
        f"src/{slug}/pipelines/example_pipeline.py",
        f"src/{slug}/pipelines/streaming_pipeline.py",
        f"src/{slug}/entrypoint.py",
        "notebooks/run_pipeline_notebook.py",
        "notebooks/run_streaming_notebook.py",
        "notebooks/run_multiformat_notebook.py",
        "notebooks/run_database_connectors_notebook.py",
